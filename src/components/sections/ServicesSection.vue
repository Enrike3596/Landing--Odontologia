<template>
  <section id="services" class="service-section pt-150">
    <div class="shape shape-3">
      <img src="/img/shapes/shape-3.svg" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-xl-8 mx-auto">
          <div class="section-title text-center mb-55">
            ...
            <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Nuestros Servicios Odontológicos</h2>
            <p class="wow fadeInUp" data-wow-delay=".6s">Ofrecemos una amplia gama de tratamientos dentales para mantener tu sonrisa <br class="d-none d-lg-block"> saludable con la más alta calidad y tecnología moderna.</p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="service-item mb-30">
            ...
            <div class="service-content">
              ...
              <p>Exámenes rutinarios, limpiezas dentales, empastes y tratamientos preventivos para mantener tu salud bucal en óptimas condiciones.</p>
              <a href="#" class="read-more">Leer Más <i class="lni lni-arrow-right"></i></a>
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item mb-30">
            ...
            <div class="service-content">
              <h4>Ortodoncia</h4>
              <p>Corrección de la posición de los dientes y mejora de la mordida con brackets, invisalign y otros tratamientos ortodónticos.</p>
              <a href="#" class="read-more">Leer Más <i class="lni lni-arrow-right"></i></a>
            </div>
            <div class="service-overlay img-bg"></div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item mb-30">
            ...
            <div class="service-content">
              <h4>Endodoncia</h4>
              <p>Tratamiento de conductos para salvar dientes dañados o infectados, aliviando el dolor y preservando la estructura dental natural.</p>
              <a href="#" class="read-more">Leer Más <i class="lni lni-arrow-right"></i></a>
            </div>
            <div class="service-overlay img-bg"></div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item mb-30">
            ...
            <div class="service-content">
              <h4>Periodoncia</h4>
              <p>Tratamiento de enfermedades de las encías y tejidos de soporte dental para mantener una base sólida para tus dientes.</p>
              <a href="#" class="read-more">Leer Más <i class="lni lni-arrow-right"></i></a>
            </div>
            <div class="service-overlay img-bg"></div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item mb-30">
            ...
            <div class="service-content">
              ...
              <p>Extracciones, implantes dentales y procedimientos quirúrgicos avanzados realizados con precisión y cuidado profesional.</p>
              <a href="#" class="read-more">Leer Más <i class="lni lni-arrow-right"></i></a>
            </div>
            <div class="service-overlay img-bg"></div>
          </div>
