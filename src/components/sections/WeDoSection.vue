<template>
  <section class="we-do-section pt-150">
    <div class="shape shape-1">
      <img src="/img/shapes/shape-1.svg" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-xl-8 mx-auto">
          <div class="section-title text-center mb-55">
            <span class="wow fadeInDown" data-wow-delay=".2s">Qué Ofrecemos</span>
            <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">Servicios Que Brindamos Para Tu Salud Dental</h2>
            <p class="wow fadeInUp" data-wow-delay=".6s">Ofrecemos una amplia gama de servicios odontológicos para mantener <br class="d-none d-lg-block"> tu sonrisa saludable y radiante con la mejor atención profesional.</p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-xl-12">
          <div class="graph mb-60">
            <img src="/img/we-do/graph-img.svg" alt="">
          </div>
        </div>
        <div class="col-lg-3">
          <div class="we-do-item mb-30">
            ...
            <h5>Odontólogos Especialistas</h5>
          </div>
        </div>
        <div class="col-lg-3">
          <div class="we-do-item mb-30">
